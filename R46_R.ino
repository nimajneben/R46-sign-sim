...
const char sign4[] PROGMEM = "A,8 AB EXPRESS,to207 ST/MANHTN";
...
const char sign24[] PROGMEM = "G,CROSSTOWN LCL,LONG IS. CITY,COURT SQ";
const char sign25[] PROGMEM = "G,CROSSTOWN LCL,CULVER LOCAL,KENSNGTON-BKLYN,CHURCH AV";
...
//Initalize with my liking sign.
String stsign1 = " BAY RIDGE-95 ST";
String stsign2 = "     via 59 ST  ";
String stsign3 = "  BROADWAY LOCAL";
String stsign4 = "";
...
{
  char sign_buffer = "\0";
  strcpy_P(buffer, (char*)pgm_read_word(&(sign_table[5])));
  ...
  do
  {
    ...
    lcd.print(x);
    lcd.setCursor(0, 1);
    lcd.print(String(displays[x]));
    scan_replace(String(displays[x]));
    x = x + 1;
    delay(3000);
  } while (x<5);
  x = 1;
